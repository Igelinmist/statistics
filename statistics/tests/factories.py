...
from statistics.models import Journal, Record
...
def prepare_journal_tree():
    ...
    detail11 = UnitFactory(plant_id=subunit1.id, name='detail11')
    detail12 = UnitFactory(plant_id=subunit1.id, name='detail12')
    detail21 = UnitFactory(plant_id=subunit2.id, name='detail21')
    detail22 = UnitFactory(plant_id=subunit2.id, name='detail22')
    full_journal = JournalFactory(equipment_id=subunit1.id, extended_stat=True)
    JournalFactory(equipment_id=subunit2.id, extended_stat=True)
    ...
    return {'full_journal': full_journal}
